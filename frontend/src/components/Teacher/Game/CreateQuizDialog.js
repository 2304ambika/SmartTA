...
import { generateNewQuizTooltips } from '../../content';
...
const CreateQuizDialog = ({ open, handleClose }) => {
  ...
  const handleGenerateQuestions = async () => {
    ...
    try {
      ...
      const response = await axios.post(url_backend+'/generate-quiz', formData, {
        headers: {
  ...
  return (
    <Dialog open={open} onClose={handleClose}>
      ...
      <Box marginBottom={0}>
      {/* <RolloverTooltip content={generateNewQuizTooltips.useTab} arrow> */}
      ...
      {tabValue === 0 && (
        <Box mt={1} paddingBottom={1}>
          {/* <RolloverTooltip content={generateNewQuizTooltips.useTextTab} arrow> */}
          <TextField
      ...
      {tabValue === 1 && (
        <Box mt={1} paddingBottom={1}>
          {/* <RolloverTooltip content={generateNewQuizTooltips.uploadFileTab} arrow> */}
          <TextField
      ...
      {/* <Box gap={2}> */}
        ...
        {/* <RolloverTooltip content={generateNewQuizTooltips.titleInput} arrow> */}
        <TextField
            label="Title"
            variant="outlined"
            fullWidth
          ...
          />
          {/* </RolloverTooltip> */}
          {/* <RolloverTooltip content={generateNewQuizTooltips.numQuestionsInput} arrow> */}
          <TextField
          ...
          {/* <RolloverTooltip content={generateNewQuizTooltips.questionTypesSelect} arrow> */}
    ...
    {/* </RolloverTooltip> */}
    {/* <RolloverTooltip content={generateNewQuizTooltips.purposeSelect} arrow> */}
          <FormControl fullWidth>
