...
import { whiteboardPageContent } from '../content';
...
const Whiteboard = () => {
  ...
  const handleUpload = async () => {
    ...
    try {
      const response = await axios.post(url_backend+'/upload', formData, {
        headers: {
      ...
      <Grid container>
        ...
        <Typography variant="h4" gutterBottom>
          ...
          <Box sx={{ textAlign: 'center', marginTop: 4 }}>
            ...
            {/* <RolloverTooltip content={whiteboardPageContent.uploadImage}> */}
              <TextField
                type="file"
                ...
                sx={{ marginBottom: 2,marginRight: 2, width: '300px' }}
              />
              {/* </RolloverTooltip> */}
              <RolloverTooltip content={whiteboardPageContent.processImage}>
              <Button
                variant="contained"
                color="primary"
            ...
            {result && (
              <Box sx={{ marginTop: 4 }}>
                <Box>
                  ...
                  {/* <RolloverTooltip content={whiteboardPageContent.copyText}> */}
                    <Button onClick={handleCopy} startIcon={copied ? <CheckIcon /> : <FileCopyIcon />} sx={{ mr: 2 }}>
                      {copied ? 'Copied' : 'Copy Text'}
                    </Button>
                    {/* </RolloverTooltip> */}
                    {/* <RolloverTooltip content={whiteboardPageContent.download}> */}
