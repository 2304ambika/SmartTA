...
import {Menu as MenuIcon, Summarize, Note, Slideshow, Quiz, Logout,AccountCircle} from '@mui/icons-material';
    ...
    <Box sx={{ height: '100%', display: 'flex', flexDirection: 'column' }}>
      ...
      <Box sx={{ flexGrow: 1 }}>
        ...
        <ListItemButton component={Link} to="/quiz-landing">
          ...
          <ListItemButton component={Link} to="/poll-create">
            <ListItemIcon><Quiz /></ListItemIcon>
            <ListItemText primary="Create Poll" />
          </ListItemButton>
          <ListItemButton component={Link} to="/whiteboard">
            <ListItemIcon><Note /></ListItemIcon>
            <ListItemText primary="Scan Whiteboard" />
          </ListItemButton>
      ...
      <Box>
        <List>
          ...
          {/* Uncomment and import HelpOutlineOutlinedIcon if you need to use it */}
